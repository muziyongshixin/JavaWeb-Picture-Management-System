    ...
    <div class="row row-offcanvas row-offcanvas-left">
        ...
        <div class="col col-xs-12 col-sm-9">
            ...
            <section class="row" id="website_templates">
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-12">
                        <a href="AllPersonPic.jsp" class="btn btn-primary" role="button">查看更多</a>
                    </div>
                </div>
            </section> <!-- website templates -->

            <section class="row" id="mini_templates">
                <div class="row">
                    <div class="col-xs-12 col-md-12">
                        <h3>风景图片</h3>
                    </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-12">
                        <div class="item_container">
                            <% String category1 = "风景图片";
                                QueryAllPhoto query1 = new QueryAllPhoto();
                                ArrayList sight_pic_list = query1.QueryByExt(category1);

                            %>

                            <%
                                for (int i = 0; i < 8 && i < sight_pic_list.size(); i++) {
                                    PhotoInfoEntity tem = (PhotoInfoEntity) sight_pic_list.get(i);
                            %>
                            <div class="item">
                                <a href="item_preview.jsp?id=<%=tem.getId()%>&dir=<%=tem.getDir()%>&ext=<%=tem.getExt()%>&realName=<%=tem.getRelName()%>&ip=<%=tem.getIp()%>&dt=<%=tem.getDt()%>&info=<%=tem.getInfo()%>"
                                   class="thumbnail">
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-12">
                        <a href="AllSightPic.jsp" class="btn btn-primary" role="button">查看更多</a>
                    </div>
                </div>
            </section> <!-- mini templates -->

            <section class="row" id="flash_templates">
                <div class="row">
                    <div class="col-xs-12 col-md-12">
                        <h3>卡通图片</h3>
                    </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-12">
                        <div class="item_container">
                            <% String category2 = "卡通图片";
                                QueryAllPhoto query2 = new QueryAllPhoto();
                                ArrayList cartoon_pic_list = query2.QueryByExt(category2);

                            %>

                            <%
                                for (int i = 0; i < 8 && i < cartoon_pic_list.size(); i++) {
                                    PhotoInfoEntity tem = (PhotoInfoEntity) cartoon_pic_list.get(i);
                            %>
                            <div class="item">
                                <a href="item_preview.jsp?id=<%=tem.getId()%>&dir=<%=tem.getDir()%>&ext=<%=tem.getExt()%>&realName=<%=tem.getRelName()%>&ip=<%=tem.getIp()%>&dt=<%=tem.getDt()%>&info=<%=tem.getInfo()%>"
                                   class="thumbnail">
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-12">
                        <a href="AllCartoonPic.jsp" class="btn btn-primary" role="button">查看更多</a>
                    </div>
                </div>
